...
const inputClass = 'h-[3.35rem] rounded-[1rem] border border-[var(--slot4-border)] bg-[var(--slot4-surface-bg)] px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-soft-muted-text)] focus:border-[var(--slot4-accent-fill)] focus:bg-white'
const buttonClass = 'inline-flex h-[3.35rem] items-center justify-center rounded-[1rem] bg-[#4361ee] px-6 text-xs font-black uppercase tracking-[0.18em] text-white transition hover:bg-[var(--slot4-accent-fill)] disabled:opacity-60'
